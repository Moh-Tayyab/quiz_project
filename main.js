...
const quiz = [
    {
        ...
        correctAnswer: "C) A strongly typed programming language that builds on JavaScript",
    },
    {
    ...
    {
        question: "Which option is the correct way to compile a TypeScript file to JavaScript?",
        choices: [
            "A) ts script.ts",
            "B) tsc script.ts",
            "C) compile script.ts",
    ...
    {
        question: "Choose the correct TypeScript syntax for making a property optional in an interface?",
        choices: [
    ...
    {
        question: "Which of the following access modifiers makes a class member accessible only within the class itself?",
        choices: ["A) public", "B) protected", "C) private", "D) internal"],
        correctAnswer: "C) private",
    },
    {
        question: "How do you annotate a variable with a custom type in TypeScript?",
        choices: [
            "A) let x: MyType",
            "B) let x = MyType",
            "C) let x as MyType",
    ...
    {
        question: "In TypeScript, which character is used to separate function parameters from the function return type?",
        choices: ["A) :", "B) =>", "C) =", "D) ->"],
        correctAnswer: "B) =>",
    },
    {
        question: "What is the term for TypeScript's ability to infer the type of a variable, parameter, or return value?",
        choices: [
            "A) Type deduction",
            "B) Type assertion",
            "C) Type casting",
    ...
    {
        question: "Which of the following is NOT a valid tuple type declaration in TypeScript?",
        choices: [
    ...
    {
        question: "Which of the following types is assignable to 'void' in TypeScript?",
    ...
    {
        question: "How do you make all properties of a TypeScript interface readonly?",
        choices: [
    ...
    {
        question: "What is the syntax to declare a class that implements an interface in TypeScript?",
        choices: [
